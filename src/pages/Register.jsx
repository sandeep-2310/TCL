  ...
  return (
    <div className="auth-page fade-in">
      <div className="auth-banner">
        ...
        <h1>Join Our<br/>Spiritual Community</h1>
        <p className="auth-tagline">"Come to me, all who are weary." — Matthew 11:28</p>
      </div>

      <div className="auth-card">
        <h2>Create Account</h2>
        <p className="auth-subtitle">Begin your blessed journey with us</p>
